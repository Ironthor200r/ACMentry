...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  Future<void> _register() async {
    try {
      ...
      // Log registration event to Firebase Analytics
      _logRegistrationEvent();
  ...
  // Log registration event with Firebase Analytics
  void _logRegistrationEvent() {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..shader = LinearGradient(
        colors: [
          Color.fromRGBO(232, 166, 186, 1),
          Color.fromRGBO(233, 137, 166, 1),
        ],
